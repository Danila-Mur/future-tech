	...
	updateUI() {
		...
		const updateOptions = () => {
			this.optionElements.forEach((option, index) => {
				...
				option.setAttribute(this.stateAttributes.ariaSelected, isSelected);
			});
		};
